    ...
    <div className="space-y-6 fade-rise">
      <section className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700">
            Last 7 Days
          </button>
          <button className="inline-flex items-center gap-2 rounded-xl bg-teal-700 px-3 py-2 text-xs font-semibold text-white">
